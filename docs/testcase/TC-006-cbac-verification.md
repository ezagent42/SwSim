...
- **验收标准**：
  - `flow_states["msg-001"].state` = `submitted`，`subject_author` = `alice:Alice@local`
  - `flow_states["msg-003"].state` = `submitted`，`subject_author` = `alice:Alice@local`
...
- **验收标准**：
  - msg-003 的 `subject_author` = `alice:Alice@local`
...
- **验收标准**：
  ...
  - 回溯到 msg-003 的 `subject_author` = `alice:Alice@local`
